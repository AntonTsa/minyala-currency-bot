...
/**
 * Handles fetching and formatting currency information
 * based on user settings.
 */
public class HandleGetInfo {

    /**
     * Fetches currency rates from the selected bank(s)
     * and formats them according to user preferences.
     *
     * @param userSettings the user's settings including bank choice,
