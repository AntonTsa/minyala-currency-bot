...
/**
 * Unit test for {@link NbuServiceImpl} using real JSON content from NBU API.
 * Validates correct parsing and one-hour cache behavior.
 */
public class NbuServiceImplRealJsonTest {
    ...
    private NbuServiceImpl service;
    private HttpClient httpClientMock;

    @BeforeEach
    void setUp() throws Exception {
        service = NbuServiceImpl.getInstance();
